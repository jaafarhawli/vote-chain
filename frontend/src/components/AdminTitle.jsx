    ...
    <div className='fixed pl-[300px] w-full'>
      <div className='w-full bg-purple-100 py-6 flex justify-between px-8 items-center'>
        ...
        <div className='flex gap-8 items-center'>
            <AiFillHome className='text-white text-[30px] hover:text-white/80 duration-150' />
            <button className='bg-white/20 px-6 py-6'>{localStorage.firstname} {localStorage.lastname}</button>
        </div>
      </div>
    </div>
  );
