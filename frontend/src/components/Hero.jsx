  ...
  return (
    ...
    <div className='flex flex-col bg-gradient-to-b from-black-100 to to-black-200 min-h-[500px]'>
      ...
      <div className='flex h-full flex-1 lg:pl-28 md:pl-10 pl-4 justify-between'>
        ...
        <img src={landingsm} alt="talents" className="w-[50%] md:hidden hidden sm:flex mt-5" />
        <img src={landinglg} alt="talents" className="w-[45%] hidden md:flex mt-5" />
      </div>
    </div>
      <div className='aspect-[960/200] w-full bg-no-repeat bg-center bg-cover'  style={{backgroundImage: `url(${curve})`}}></div>
    </div>
  );
}
