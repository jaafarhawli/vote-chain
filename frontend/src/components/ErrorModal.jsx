...
const ErrorModal = ({open, closeError, error}) => {
  ...
  return (
    <div className='bg-black-100/50 fixed w-full h-full z-10 ' onClick={closeError}>
     <div className=' fixed top-[5%] left-1/2 -translate-x-1/2 w-2/3 max-w-[400px] flex bg-red/70 shadow-xl items-center gap-2 z-10 rounded-lg p-4 ' onClick={(e) => e.stopPropagation()}>
