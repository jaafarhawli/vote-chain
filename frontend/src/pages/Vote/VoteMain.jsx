      ...
      <div className='flex h-full flex-1 lg:pl-28 md:pl-10 pl-4 sm:justify-between justify-center'>
        <div className='flex flex-col justify-center sm:items-start items-center text-center sm:text-left'>
            ...
            <div className='flex gap-4 mt-6'>
                ...
                <Button className={'border-cyan border-2 bg-opacity-0 hover:bg-cyan disabled:hover:bg-black-200 disabled:border-none'} disabled={disabled || live} onClick={() => navigate('results')} >Check Results</Button>
            </div> 
        </div>
